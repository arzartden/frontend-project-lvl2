...
test('diffGen.js', () => {
  ...
  expect(diffGen(getFixturePath('file1.json'), getFixturePath('file2.yml'))).toEqual(readFile('expected_file.txt'));
  expect(diffGen(getFixturePath('file1.yml'), getFixturePath('file2.json'))).toEqual(readFile('expected_file.txt'));
});
